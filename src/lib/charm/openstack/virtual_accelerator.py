...
class VirtualAcceleratorCharm(OpenStackCharm):
    ...
    def install_va(self):
        ...
        hookenv.log('Set hold mark on %s to prevent our 6WIND version from'
                    ' being overridden' % self.ovs_pkg, level=hookenv.INFO)
    ...
    def uninstall_va(self):
        ...
        hookenv.status_set('maintenance', 'Reinstall original %s' %
                           self.ovs_pkg)
    ...
    def install_os_extensions(self):
        ...
        hookenv.status_set('maintenance',
                           'Installing 6WIND Openstack Extensions')
        hookenv.log('Installing 6WIND Openstack Extensions',
                    level=hookenv.INFO)
    ...
    def uninstall_os_extensions(self):
        ...
        """
        hookenv.status_set('maintenance',
                           'Uninstalling 6WIND Openstack Extensions')
        hookenv.log('Uninstalling 6WIND Openstack Extensions',
                    level=hookenv.INFO)
